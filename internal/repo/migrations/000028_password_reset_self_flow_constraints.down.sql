...
WHERE purpose = 'password_reset_self';
...
ADD CONSTRAINT email_verification_challenges_purpose_check CHECK (
    purpose IN ('register', 'password_login_step_up', 'password_reset', 'password_attach')
);

UPDATE auth_rate_limits
SET scope = 'password_reset_send'
WHERE scope = 'password_reset_self_init';
