...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/auth/is_valid": {
            "get": {
                "description": "Returns the current authentication state and user profile derived from the session cookie.",
                "tags": [
                    "Authentication"
                ],
        ...
        "/api/auth/logout": {
            "post": {
                "description": "Invalidates the current session, clears the session cookie, and revokes the provider token when possible.",
                "tags": [
                    "Authentication"
                ],
                "summary": "Log out",
        ...
        "/api/auth/{provider}/callback": {
            "get": {
                "description": "Validates the OAuth state, creates or links the user, and redirects back to the frontend.",
                "tags": [
                    "Authentication"
                ],
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Unknown provider or invalid state",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/auth/{provider}/login": {
            "get": {
                "description": "Redirects the caller to the configured OAuth provider login page.",
                "tags": [
                    "Authentication"
                ],
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "OAuth state generation failure",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
